...
The reader remains the intake client. `jnap-life-graph` remains the likely graph of record. This slice adds the contracts,
SQL migration proposal, and dry-run endpoint needed to review that boundary.
