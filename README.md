...
The Life Graph adapter is intentionally dry-run first. It maps configured sources and feed works into Life Graph `life_object`
records and `derived_from_source` edges, but it does not write to Postgres.
